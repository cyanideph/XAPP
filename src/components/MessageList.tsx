    ...
    <ScrollView contentContainerStyle={{ padding: 16, gap: 10 }}>
      ...
      <YStack gap="$3">
        {messages.map((message) => {
          ...
          return (
            <YStack key={message.id} style={{ alignSelf: own ? "flex-end" : "flex-start" }} maxWidth="88%" bg={own ? '$color' : '$background'} borderWidth={1} borderColor="$borderColor" borderRadius="$6" p="$3">
