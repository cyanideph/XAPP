...
export default function RootLayout() {
  ...
  if (loading) return <TamaguiProvider config={tamaguiConfig} defaultTheme={colorScheme}><YStack flex={1} ai="center" jc="center" bg="$background"><Spinner /></YStack></TamaguiProvider>;
