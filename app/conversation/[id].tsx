...
export default function ConversationScreen() {
  ...
  const { messages, loading, sending, send } = useChatMessages({ scope: 'conversation', id });
  return (
    <YStack flex={1} backgroundColor="$background">
      <YStack padding="$4" borderBottomWidth={1} borderColor="$borderColor"><H1 fontSize="$7">Chat</H1></YStack>
