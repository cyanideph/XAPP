...
export default function ProfileScreen() {
  ...
  return <ScrollView contentContainerStyle={{ padding: 20, paddingTop: 64 }}><YStack gap="$3">
    <Text fontSize="$3" color="$colorPress" fontWeight="800">PROFILE</Text><H1>Edit profile.</H1><BentoCard title="Public identity" description="Keep your identity and status current."><Input value={profile.username} onChangeText={v => setProfile({ ...profile, username: v })} placeholder="Username" autoCapitalize="none" />
